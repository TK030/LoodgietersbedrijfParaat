...
<body>
  ...
  <section id="hero" class="hero">
    ...
    <div class="hero-img">
      <img src="images/hero.jpg" alt="Loodgieter aan het werk">
    </div>
  </section>
  ...
  <section id="over" class="overons section-light">
    <div class="overons-content">
      <div class="overons-img">
        <img src="images/team.jpg" alt="Ons team">
      </div>
      <div>
  ...
  <section id="blog" class="blog section-dark">
    ...
    <div class="blog-grid">
      <article class="blogpost">
        <img src="images/blog1.jpg" alt="Blog loodgieter tips">
      ...
      <article class="blogpost">
        <img src="images/blog2.jpg" alt="Blog cv onderhoud">
      ...
      <article class="blogpost">
        <img src="images/blog3.jpg" alt="Blog lekkage oplossen">
